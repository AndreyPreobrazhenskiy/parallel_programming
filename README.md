...
<img width="2372" height="1469" alt="time_vs_size" src="https://github.com/user-attachments/assets/c45236c0-55b3-4981-9efb-17ac2988bdcf" />


### График зависимости производительности от размера матрицы:

<img width="2372" height="1469" alt="gflops_vs_size" src="https://github.com/user-attachments/assets/fbf87f0c-3747-4bc9-9a46-5a8b3466167a" />


> Время растёт как **O(N³)**. GFLOPS снижается при больших N из-за ограничений памяти.
